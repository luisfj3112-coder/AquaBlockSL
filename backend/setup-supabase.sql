...
-- Crear tabla para los documentos (ofertas y facturas)
...
-- Crear el bucket de almacenamiento para los documentos si no existe
insert into storage.buckets (id, name, public)
values ('documents', 'documents', true)
on conflict (id) do update set public = true;

-- Políticas de seguridad para el bucket documents
